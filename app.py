...
I18N = {
    "中文": {
        ...
        "metrics": [
            ("12", "覆盖审计、商业研究、AI、医疗健康、国际贸易和产品原型的作品集项目"),
            ("30+", "实习期间支持的企业函证流程案例"),
    ...
    "English": {
        ...
        "chips": ["Audit & Accounting", "Business Research", "AI × Finance", "AI × Healthcare", "People Operations"],
        "metrics": [
            ("12", "Portfolio projects across audit, research, AI, healthcare, international trade and product prototypes"),
...
DOWNLOAD_FILES = {
    ...
    "oppo_plan": "assets/projects/OPPO策划案.pdf",
}
...
PROJECTS = {
    "中文": [
        ...
        {
            "id": "oppo_rcep_market_entry",
            "name": "OPPO RCEP 智能手机市场开拓策划案",
            "category": "Business Research & Consulting",
            "tags": ["OPPO", "RCEP", "国际贸易", "市场进入策略", "LPI", "TPI", "智能手机"],
            "summary": "以 OPPO 智能手机出海为背景，基于 RCEP 国家物流效率、出口规模和贸易潜力，构建目标市场筛选框架，并提出差异化市场进入策略。",
            "logic": {
                "Problem": "中国智能手机品牌在 RCEP 市场面临需求分化、物流效率差异、通关复杂度和本地竞争压力",
                "Method": "结合出口数据、物流绩效指数 LPI、贸易潜力指数 TPI 和目标市场分级，筛选高潜力进入市场",
                "Output": "形成市场筛选、目标市场定位、物流优先级划分和 OPPO 市场开拓建议",
                "Value": "展示国际贸易数据分析、市场研究和咨询式策略输出能力",
            },
            "details": [
                "**产品与行业背景梳理：** 分析智能手机的高附加值、迭代快、供应链全球化和品牌竞争强等特征，解释为什么物流效率会直接影响出口市场开拓。",
                "**全球贸易与 RCEP 市场分析：** 梳理新兴市场增长、发达国家需求疲软、区域经济一体化趋势，判断 RCEP 国家对中国智能手机出口的战略意义。",
                "**数据采集与清洗：** 整理 RCEP 国家智能手机出口规模、物流绩效指数（LPI）、人口和市场需求等指标，构建结构化市场分析表。",
                "**市场筛选模型设计：** 将出口规模、物流效率和贸易潜力结合，使用 LPI 与出口额交叉分析识别高吸引力市场，并进行目标市场初步定位。",
                "**贸易潜力指数构建：** 通过 TPI 评估不同国家的出口潜力，区分优先进入市场、培育型市场和谨慎进入市场，避免只看单一出口规模做决策。",
                "**策略建议输出：** 从差异化布局、物流优先、产品适配和合规先行四个方向，为 OPPO 在 RCEP 市场开拓提出可执行建议。",
                "**咨询式表达能力：** 将数据分析结果转化为市场分级、进入路径和策略建议，形成适合竞赛答辩和商业分析岗位展示的完整策划案。",
            ],
            "tools": ["Excel", "LPI Analysis", "TPI Index", "International Trade", "Market Sizing", "Strategy Framework"],
            "deliverables": ["市场策划案 PDF", "RCEP 市场筛选框架", "目标市场分级", "市场进入建议"],
            "target_roles": ["行业研究", "咨询", "商业分析", "国际贸易", "市场策略"],
            "downloads": [{"label": "下载 OPPO 策划案", "path": DOWNLOAD_FILES["oppo_plan"]}],
            "github_url": "",
            "demo_url": "",
            "image_file": "",
        },
        ...
        {
            "id": "trr_dry_bulk_forecasting",
            "name": "干散货运价预测与可解释性分析项目（DA-MTS+LSTM）",
            "category": "AI × Finance",
            "tags": ["时间序列预测", "Shipping Finance", "Transformer", "LSTM", "MIC", "可解释性分析"],
            "summary": "参与干散货运价预测与可解释性分析研究，围绕 BDI、BCI、BPI 等航运价格指数，使用多源时间序列、MIC 相关性筛选和 DA-MTS+LSTM 混合模型分析运价波动与突发事件影响。",
            "logic": {
                "Problem": "干散货运价受宏观经济、地缘冲突、大宗商品、能源价格和突发事件影响，传统模型难以同时捕捉长期趋势与短期冲击",
                "Method": "整合航运、金融和大宗商品多源时间序列，使用 MIC 筛选相关变量，并结合 Transformer-based DA-MTS 与 LSTM 残差修正",
                "Output": "完成变量清洗、相关性分析、模型误差对比、异常事件标注和结构化分析底稿",
                "Value": "提升对复杂金融/航运市场的量化分析能力，展示从数据处理到模型解释的研究型项目经验",
            },
            "details": [
                "**多源数据清洗与标准化：** 参与整合航运、金融、大宗商品等领域的多源时间序列数据，对缺失值、异常值和变量口径进行检查，并使用 Min-Max 标准化保证模型输入一致性。",
                "**突发事件变量构建：** 将地缘冲突、经济危机、公共卫生事件等突发因素编码为二进制事件变量，用于分析短期冲击对 BDI、BCI、BPI 运价指数的影响。",
                "**MIC 相关性分析：** 使用最大信息系数（MIC）识别外生变量与运价指数之间的非线性关联，筛选与运价波动更相关的微观指标，并整理相关性排序表。",
                "**模型误差对比：** 对比 ARIMA、Prophet、LSTM 等基准模型与 DA-MTS+LSTM 模型的 MAE、RMSE、MAPE 指标，辅助判断混合模型在预测精度上的改进。",
                "**可解释性与底稿整理：** 记录变量来源、处理口径、计算参数和中间结果，形成可复核的分析底稿，提升团队后续检查和论文整理效率。",
                "**研究表达能力：** 将复杂模型逻辑拆解为“数据输入 → 变量筛选 → 迁移学习预测 → 残差修正 → 事件解释”的流程，便于非技术面试官理解项目价值。",
            ],
            "tools": ["Python", "Time Series", "MIC", "Transformer", "LSTM", "Excel", "Research Writing"],
            "deliverables": ["TRR 论文 PDF", "变量清洗底稿", "相关性分析表", "模型误差对比结果"],
            "target_roles": ["行业研究", "量化研究助理", "数据分析", "AI 财务分析", "商业分析"],
            "downloads": [{"label": "下载 TRR 论文", "path": DOWNLOAD_FILES["trr_paper"]}],
            "github_url": "",
            "demo_url": "",
            "image_file": "",
        },
...
PROJECTS["English"] = [
    {
        ...
        "name": "Audit Confirmation Workflow with AI-assisted Data Processing",
        "category": "Audit & Accounting",
        "tags": ["Audit Workflow", "Excel", "VBA", "DeepSeek", "Dify"],
        "summary": "During my internship at Baker Tilly China, I supported 30+ audit confirmation workflows, covering dispatch, tracking, returned-confirmation checks and exception handling, while using Excel, VBA and AI tools to improve repetitive data-processing tasks.",
        "logic": {
            "Problem": "Audit confirmation work involves repeated data sorting, status tracking and exception checks",
            "Method": "Used advanced Excel functions, pivot tables, VBA and AI tools to support workflow processing",
            "Output": "Built progress trackers, extraction templates, batch-renaming scripts and knowledge-base exploration",
            "Value": "Improved workflow visibility and helped managers identify exceptions more efficiently",
        },
        "details": [
            "**End-to-end workflow support:** Supported 30+ company confirmation workflows, including dispatch tracking, returned-confirmation verification, exception handling and progress updates.",
            "**Data cleaning and efficiency improvement:** Used VLOOKUP, XLOOKUP, COUNTIF and pivot tables to process confirmation data in batches and standardize tracking outputs.",
            "**AI-assisted automation:** Used DeepSeek to assist VBA scripting for batch file renaming, data cleaning and exception tagging.",
            "**Business rule structuring:** Translated confirmation checks, bank-flow remarks and exception-handling rules into clear instructions and decision logic.",
            "**Audit-tech exploration:** Participated in Dify knowledge-base, RPA and OCR testing to understand how AI can support audit operations.",
        ],
        "tools": ["Excel", "VBA", "DeepSeek", "Dify", "RPA/OCR"],
        "deliverables": ["Sanitized process summary", "Confirmation progress tracker", "Automation templates"],
        "target_roles": ["Audit", "Accounting", "Shared Services", "Audit Data Analytics"],
        "downloads": [],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "IPO Earnings Management Research",
        "category": "Audit & Accounting",
        "tags": ["Audit Research", "IPO", "Stata", "Modified Jones Model"],
        "summary": "Using 2011-2024 A-share IPO samples, this research examines whether auditor industry specialization can restrain accrual-based earnings management.",
        "logic": {
            "Problem": "IPO firms may have incentives to manage accrual earnings before or around listing",
            "Method": "Measured AbsDA with the Modified Jones model and constructed auditor industry-specialization variables",
            "Output": "Completed fixed-effects regressions, instrumental-variable tests, mechanism analysis and paper writing",
            "Value": "Explains how audit supply capability can improve IPO earnings quality",
        },
        "details": [
            "**Research question framing:** Focused on accrual-based earnings management around IPOs and the governance role of audit supply capability.",
            "**Variable design:** Used auditor industry specialization to measure audit supply capability and the Modified Jones model to estimate accrual earnings management.",
            "**Model construction:** Built panel regression models with year fixed effects to test the relationship between specialization and earnings management.",
            "**Robustness and endogeneity treatment:** Used same-industry same-year specialization averages as an instrumental variable to mitigate endogeneity concerns.",
            "**Mechanism analysis:** Discussed the roles of audit-firm scale and audit fees in the specialization-earnings-management relationship.",
        ],
        "tools": ["CSMAR", "Stata", "Modified Jones", "Fixed Effects", "IV"],
        "deliverables": ["Research paper", "Variable definition table", "Stata do file"],
        "target_roles": ["Audit", "Accounting Research", "Data Analysis"],
        "downloads": [
            {"label": "Download Paper PDF", "path": DOWNLOAD_FILES["ipo_earnings_pdf"]},
            {"label": "Download Stata Do File", "path": DOWNLOAD_FILES["ipo_earnings_do"]},
        ],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "Volkswagen Industry Research and Strategic Financial Analysis",
        "category": "Business Research & Consulting",
        "tags": ["Automotive", "Strategy", "Financial Analysis", "Consulting-style Deck"],
        "summary": "A consulting-style analysis of Volkswagen Group, focusing on flat revenue, margin pressure, China market challenges and software-transition bottlenecks.",
        "logic": {
            "Problem": "Legacy automakers face margin repair pressure in the EV and software-defined vehicle era",
            "Method": "Analyzed value-pool migration, financial performance, competitive landscape and software-platform constraints",
            "Output": "Produced a strategic financial analysis PDF, key conclusion pages and margin-repair recommendations",
            "Value": "Turns complex industry shifts into clear strategic and financial judgment",
        },
        "details": [
            "**Industry trend assessment:** Analyzed value-pool migration through electrification, software-defined vehicles, AI mobility and China market competition.",
            "**Financial issue breakdown:** Reviewed revenue, operating margin, net profit, cash flow and ROE to identify sources of profit-quality pressure.",
            "**Competitive benchmarking:** Compared Volkswagen with Toyota, Tesla, BYD and Chinese automakers to identify efficiency, software and cost pressures.",
            "**Strategic bottleneck diagnosis:** Assessed CARIAD, software platforms, E/E architecture and China market product-definition challenges.",
            "**Consulting-style communication:** Converted the analysis into high-density slides with conclusions, profit bridge, recommendations and risk notes.",
        ],
        "tools": ["Annual Report", "Profit Bridge", "DuPont", "Competition Analysis", "PPT"],
        "deliverables": ["Strategic financial analysis PDF", "Key conclusion pages", "Margin-repair recommendations"],
        "target_roles": ["Industry Research", "Consulting", "Strategy", "Business Analysis"],
        "downloads": [{"label": "Download Project PDF", "path": DOWNLOAD_FILES["volkswagen"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "Shaanxi Tourism IPO Business Analysis",
        "category": "Business Research & Consulting",
        "tags": ["IPO", "Cultural Tourism", "Business Model", "Financial Analysis"],
        "summary": "An IPO-oriented business analysis of Shaanxi Tourism, covering tourism industry growth, core asset barriers, performance and cableway business models, and profitability quality.",
        "logic": {
            "Problem": "How to evaluate the IPO value and business moat of a cultural tourism company",
            "Method": "Analyzed industry growth, Xi'an tourism traffic, cultural IP, performance business and cableway operations",
            "Output": "Built an IPO business analysis PDF, core asset analysis and profitability-quality view",
            "Value": "Clarifies how tourism assets convert traffic into capital-market narratives and financial value",
        },
        "details": [
            "**Industry growth analysis:** Evaluated growth drivers from domestic tourism recovery, consumption upgrade and experiential travel demand.",
            "**Core asset identification:** Analyzed scarce assets such as Xi'an cultural IP, The Song of Everlasting Sorrow and Huashan West Peak Cableway.",
            "**Business model breakdown:** Split the company into performance, cableway and other businesses to assess revenue structure and traffic conversion.",
            "**Profitability quality review:** Used margin, cash flow and core-business contribution to assess sustainability of earnings quality.",
            "**Capital-market narrative:** Integrated industry, assets, business model and financial logic into an IPO roadshow-style framework.",
        ],
        "tools": ["Prospectus", "Business Model", "Financial Analysis", "PPT"],
        "deliverables": ["IPO business analysis PDF", "Core asset analysis", "Profitability-quality assessment"],
        "target_roles": ["Consulting", "Investment Research", "Business Analysis"],
        "downloads": [{"label": "Download Project PDF", "path": DOWNLOAD_FILES["shaanxi_tourism"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "Holiland Marketing Strategy Plan",
        "category": "Business Research & Consulting",
        "tags": ["Marketing Strategy", "Consumer Behavior", "4P", "Brand Analysis"],
        "summary": "A structured marketing strategy plan for Holiland, covering brand rejuvenation, IP collaborations, consumer behavior and 4P strategy.",
        "logic": {
            "Problem": "Frequent IP collaborations generate traffic but may also cause aesthetic fatigue and weaken brand equity",
            "Method": "Combined PEST, SWOT, STP, 4P and consumer behavior analysis",
            "Output": "Produced a marketing strategy report, consumer analysis and brand-improvement recommendations",
            "Value": "Turns brand-heat issues into actionable marketing optimization paths",
        },
        "details": [
            "**Brand and business review:** Analyzed Holiland's development stages, core product lines, direct-store model and multi-brand matrix.",
            "**Market environment analysis:** Used PEST, SWOT and competitor analysis to assess bakery industry competition and consumption-upgrade trends.",
            "**Consumer behavior research:** Examined target customers through consumer profiles, purchase motivations, 6W1H and Gen Z emotional value.",
            "**Problem diagnosis:** Identified risks around frequent IP collaborations, delayed health-oriented transformation, IP dependence and pricing controversy.",
            "**Strategy recommendations:** Proposed product, pricing, channel and promotion improvements based on the 4P framework.",
        ],
        "tools": ["PEST", "SWOT", "STP", "4P", "Consumer Analysis"],
        "deliverables": ["Marketing strategy report", "Consumer analysis", "Brand strategy recommendations"],
        "target_roles": ["Marketing", "Consulting", "Business Analysis"],
        "downloads": [{"label": "Download Report PDF", "path": DOWNLOAD_FILES["holiland"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        "id": "oppo_rcep_market_entry",
        "name": "OPPO RCEP Smartphone Market Entry Plan",
        "category": "Business Research & Consulting",
        "tags": ["OPPO", "RCEP", "International Trade", "Market Entry", "LPI", "TPI", "Smartphone"],
        "summary": "A market-entry strategy project for OPPO smartphones, using RCEP logistics efficiency, export scale and trade-potential indicators to identify high-potential target markets.",
        "logic": {
            "Problem": "Chinese smartphone brands face demand fragmentation, logistics-efficiency gaps, customs complexity and local competition across RCEP markets",
            "Method": "Combined export data, Logistics Performance Index, Trade Potential Index and market-tiering analysis to screen target markets",
            "Output": "Built a market-screening framework, target-market ranking, logistics-priority view and OPPO market-entry recommendations",
            "Value": "Demonstrates international trade analysis, market research and consulting-style strategy output",
        },
        "details": [
            "**Product and industry framing:** Analyzed smartphones as high-value, fast-iteration and globally supplied consumer electronics products, explaining why logistics efficiency matters for export expansion.",
            "**RCEP market analysis:** Reviewed emerging-market growth, developed-market weakness and regional trade integration to assess RCEP's strategic importance for Chinese smartphone exports.",
            "**Data collection and cleaning:** Organized export scale, LPI, population and demand-related indicators across RCEP countries to build a structured market-analysis dataset.",
            "**Market-screening model:** Combined export size, logistics efficiency and trade potential to identify attractive markets through LPI-export cross-analysis.",
            "**Trade Potential Index design:** Used TPI to classify markets into priority-entry, cultivation and cautious-entry groups instead of relying only on export volume.",
            "**Strategic recommendations:** Proposed differentiated market entry, logistics prioritization, product adaptation and compliance-first execution paths for OPPO.",
            "**Consulting-style communication:** Converted data analysis into market tiers, entry routes and actionable recommendations suitable for business-analysis and consulting roles.",
        ],
        "tools": ["Excel", "LPI Analysis", "TPI Index", "International Trade", "Market Sizing", "Strategy Framework"],
        "deliverables": ["Market plan PDF", "RCEP market-screening framework", "Target-market tiers", "Market-entry recommendations"],
        "target_roles": ["Industry Research", "Consulting", "Business Analysis", "International Trade", "Market Strategy"],
        "downloads": [{"label": "Download OPPO Plan", "path": DOWNLOAD_FILES["oppo_plan"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        "id": "financedoc_ai",
        "name": "FinanceDoc AI | Financial Document Analysis and Risk Review System",
        "category": "AI × Finance",
        "tags": ["Streamlit", "DeepSeek API", "RAG", "Multi-Agent", "Financial Analysis", "Risk Review"],
        "summary": "A Streamlit-based financial document intelligence system that supports document upload, table parsing, financial summaries, risk identification, RAG Q&A, multi-agent review and working-paper export.",
        "logic": {
            "Problem": "Financial documents, audit reports and due-diligence materials are dense and time-consuming to screen manually",
            "Method": "Built an analysis workflow with Streamlit, DeepSeek API, RAG and rule-based risk detection",
            "Output": "Generated financial summaries, risk reviews, evidence snippets and analysis working papers",
            "Value": "Productizes financial data intake, risk review and working-paper generation",
        },
        "details": [
            "**System workflow design:** Structured the app into overview, data input, financial summary, risk review, RAG Q&A, multi-agent analysis and export modules.",
            "**Multi-format parsing:** Supported PDF, Excel and CSV uploads, using PyPDF2, pandas and openpyxl to extract text and tables.",
            "**Key metric extraction:** Identified revenue, cost, profit, cash flow, assets and liabilities, then generated financial summaries and trend charts.",
            "**Risk review logic:** Used rule-based checks for revenue decline, margin pressure, cash-flow quality, leverage, expense ratio, audit opinion and related-party transactions.",
            "**RAG and multi-agent review:** Connected DeepSeek API with retrieval and specialized agents to support accounting, risk and strategy analysis.",
            "**Working-paper export:** Supported Markdown, CSV, Word and PDF outputs to make the tool closer to real finance or audit workflows.",
        ],
        "tools": ["Python", "Streamlit", "Pandas", "Plotly", "PyPDF2", "openpyxl", "DeepSeek API", "RAG", "Multi-Agent"],
        "deliverables": ["Live demo", "GitHub repository", "Financial summary", "Risk review output", "Working-paper export"],
        "target_roles": ["AI Finance", "Audit Data Analytics", "Financial Analysis", "Business Analysis", "AI Product Assistant"],
        "downloads": [],
        "github_url": PROJECT_LINKS["financedoc_ai_github"],
        "demo_url": PROJECT_LINKS["financedoc_ai_demo"],
        "image_file": "",
    ...
    {
        "id": "trr_dry_bulk_forecasting",
        "name": "Dry Bulk Freight Rate Forecasting and Interpretive Analysis",
        "category": "AI × Finance",
        "tags": ["Time Series", "Shipping Finance", "Transformer", "LSTM", "MIC", "Interpretability"],
        "summary": "A research project on dry bulk freight rate forecasting, using multi-source shipping, finance and commodity time-series data to analyze BDI, BCI and BPI movements with a DA-MTS+LSTM hybrid model.",
        "logic": {
            "Problem": "Dry bulk freight rates are affected by macroeconomic cycles, geopolitical shocks, commodity prices and unexpected events, making traditional models insufficient",
            "Method": "Integrated multi-source time-series data, used MIC for variable screening, and combined Transformer-based DA-MTS with LSTM residual correction",
            "Output": "Produced data cleaning workpapers, correlation analysis, model error comparison and event-based interpretation notes",
            "Value": "Demonstrates quantitative research capability across shipping finance, time-series analysis and AI-enabled forecasting",
        },
        "details": [
            "**Multi-source data processing:** Supported the integration and standardization of shipping, finance and commodity time-series variables, including missing-value checks, abnormal-value marking and Min-Max normalization.",
            "**Event-variable construction:** Encoded geopolitical conflicts, economic crises, public health events and other shocks as binary variables to analyze their impact on freight-rate indices.",
            "**MIC correlation analysis:** Used the Maximal Information Coefficient to identify nonlinear relationships between external variables and freight-rate indices, and organized variable-ranking tables.",
            "**Model comparison:** Compared DA-MTS+LSTM with baseline models such as ARIMA, Prophet and LSTM through MAE, RMSE and MAPE metrics.",
            "**Interpretability support:** Documented data sources, variable definitions, calculation steps and intermediate results to make the modeling workflow easier to review.",
            "**Research communication:** Translated a complex model pipeline into a clear story: data input, variable screening, transfer-learning prediction, residual correction and event interpretation.",
        ],
        "tools": ["Python", "Time Series", "MIC", "Transformer", "LSTM", "Excel", "Research Writing"],
        "deliverables": ["TRR paper PDF", "Data-cleaning workpapers", "Correlation tables", "Model comparison notes"],
        "target_roles": ["Industry Research", "Quant Research Assistant", "Data Analysis", "AI Finance", "Business Analysis"],
        "downloads": [{"label": "Download TRR Paper", "path": DOWNLOAD_FILES["trr_paper"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "Research on AGI Adoption and Corporate Governance",
        "category": "AI × Finance",
        "tags": ["AGI", "Corporate Governance", "Text Mining", "Panel Regression"],
        "summary": "A research project studying whether AGI adoption can improve corporate governance, focusing on earnings management, disclosure quality, executive compensation and related-party transactions.",
        "logic": {
            "Problem": "Can AI or AGI reduce managerial information advantages and improve governance quality",
            "Method": "Built an AGI keyword dictionary from annual-report MD&A text and matched it with governance variables",
            "Output": "Developed the research route, variable design, panel-regression framework and defense materials",
            "Value": "Turns AI strategy text into measurable corporate-governance research variables",
        },
        "details": [
            "**Research framework design:** Supported mechanism development and hypothesis design around AGI, information asymmetry and governance outcomes.",
            "**Keyword dictionary construction:** Built an AGI-related keyword dictionary based on intelligent-agent and AI strategy literature.",
            "**Text data processing:** Used Python to scan annual-report MD&A text, match keywords and construct firm-level AGI adoption indicators.",
            "**Empirical data preparation:** Integrated CSMAR, Wind and CNRDS variables with Excel and Stata for sample cleaning and panel matching.",
            "**Model and result analysis:** Supported panel regressions, moderation tests and robustness checks to evaluate AGI's governance effects.",
        ],
        "tools": ["Python", "Text Mining", "Stata", "CSMAR", "Wind", "CNRDS"],
        "deliverables": ["Project proposal", "Defense materials", "Variable design", "Technical roadmap"],
        "target_roles": ["Research", "AI Business Analysis", "Data Analysis"],
        "downloads": [
            {"label": "Download Proposal", "path": DOWNLOAD_FILES["agi_governance_pdf"]},
            {"label": "Download Defense Materials", "path": DOWNLOAD_FILES["agi_defense_pdf"]},
        ],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        ...
        "name": "City Pizza WeChat Ordering Mini Program",
        "category": "Product & Coding",
        "tags": ["WeChat Mini Program", "Product Prototype", "AI-assisted Coding", "Merchant Backend"],
        "summary": "An AI-assisted WeChat mini-program prototype covering user-side ordering flows and merchant-side backend management modules.",
        "logic": {
            "Problem": "Small restaurants need configurable ordering, product and order-management tools",
            "Method": "Designed the user ordering path, product-specification logic and merchant backend modules",
            "Output": "Completed a mini-program prototype, merchant backend pages and GitHub repository",
            "Value": "Shows the ability to move from business process to product prototype through AI-assisted coding",
        },
        "details": [
            "**Requirement breakdown:** Split restaurant needs into ordering, cart, order submission, membership and merchant backend modules.",
            "**Page architecture design:** Designed user-side tabs for home, ordering, orders and profile, plus merchant-side pages for dashboard, products, categories, orders, members, coupons and reports.",
            "**Product management logic:** Built fields for dish name, description, category, price, image URL, display order and availability status.",
            "**Specification and add-on management:** Supported single-select and multi-select specification groups, option names, prices, editing and deletion.",
            "**GitHub project packaging:** Published the mini-program code to GitHub as evidence of AI-assisted coding and product prototyping ability.",
        ],
        "tools": ["WeChat Mini Program", "JavaScript", "WXML", "WXSS", "GitHub"],
        "deliverables": ["Mini-program prototype", "Merchant backend pages", "GitHub repository"],
        "target_roles": ["Product", "Operations", "AI-assisted Coding"],
    ...
    {
        "id": "baidu_health_strategy",
        "name": "Baidu Health Industry Research and Strategy Analysis",
        "category": "Business Research & Consulting",
        "tags": ["Industry Research", "Digital Health", "AI × Healthcare", "Business Model", "Strategy"],
        "summary": "An industry and strategy analysis of Baidu Health's platform opportunity in China's digital health and internet healthcare market, covering policy, business model, competition, financial boundaries and strategic positioning.",
        "logic": {
            "Problem": "Baidu Health should not simply copy JD Health's asset-heavy pharmaceutical retail and fulfillment model",
            "Method": "Analyzed policy, business model, competitive benchmarks, operating constraints and international cases",
            "Output": "Developed platform positioning, business boundaries, monetization paths and strategic recommendations",
            "Value": "Assesses how Baidu Health can build differentiation through AI search, knowledge graphs and patient-service orchestration",
        },
        "details": [
            "**Research scope definition:** Positioned Baidu Health as a platform-layer opportunity in China's digital health industry, focusing on traffic entry, medical information organization, patient services and hospital/doctor connectivity.",
            "**Industry and policy analysis:** Reviewed digital health, internet healthcare, AI healthcare and tiered-diagnosis policies to identify suitable workflow scenarios.",
            "**Business model breakdown:** Distinguished Baidu Health from JD Health, emphasizing search traffic, AI capability, knowledge graphs and open-platform ecology over supply-chain fulfillment.",
            "**Competitive benchmarking:** Compared Baidu Health with JD Health, Alibaba Health and international digital health cases to assess transferable models and regulatory boundaries.",
            "**Information-boundary discipline:** Noted that Baidu does not separately disclose Baidu Health revenue, profit, MAU, paid conversion or GMV, so standalone financial scale should not be overstated.",
            "**Strategic recommendation:** Proposed a light-asset platform model around AI search entry, trusted health content, doctor/hospital digital tools, patient-service orchestration and B2B2C partnerships.",
        ],
        "tools": ["Industry Research", "Business Model Analysis", "Competitive Benchmarking", "Financial Analysis", "Strategy Framework", "Policy Analysis"],
        "deliverables": ["Industry research report", "Strategy framework", "Benchmarking conclusions", "Platform positioning recommendations"],
        "target_roles": ["Industry Research", "Consulting", "Strategy", "Digital Health", "AI Product Assistant", "Business Analysis"],
        "downloads": [{"label": "Download Research Report", "path": DOWNLOAD_FILES["baidu_health"]}],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
    },
    {
        "id": "fiberhome_internal_control",
        "name": "Yangtze Optical Fibre Internal Control Analysis",
        "category": "Audit & Accounting",
        "tags": ["Internal Control", "Financial Analysis", "Audit", "PPT"],
        "summary": "An internal control analysis of Yangtze Optical Fibre, focusing on control environment, business processes, financial risk indicators and audit-relevant risk identification.",
        "logic": {
            "Problem": "Manufacturing companies have complex business processes, and internal-control effectiveness affects financial quality and operational risk",
            "Method": "Combined internal-control framework, financial indicators and business-process review to identify risks",
            "Output": "Produced internal-control presentation materials and risk-identification conclusions",
            "Value": "Demonstrates accounting, audit, process-analysis and risk-identification capability",
        },
        "details": [
            "**Control environment review:** Analyzed governance structure, organizational design and business-process context to understand the control foundation.",
            "**Risk point identification:** Reviewed procurement, production, sales, cash management and inventory processes to identify potential control risks.",
            "**Financial indicator support:** Used financial data to observe operating efficiency, solvency pressure and cash-flow quality.",
            "**Report communication:** Organized the analysis into presentation materials suitable for audit, accounting and internal-control roles.",
        ],
        "tools": ["Internal Control", "Financial Analysis", "Excel", "PPT"],
        "deliverables": ["Internal control presentation", "Risk identification conclusions"],
        "target_roles": ["Audit", "Accounting", "Internal Control", "Risk Management"],
        "downloads": [
            {"label": "Download PPTX", "path": DOWNLOAD_FILES["longi_internal_control_pptx"]},
        ],
        "github_url": "",
        "demo_url": "",
        "image_file": "",
...
def nav(content: dict[str, object]) -> None:
    labels = content["nav"]
    brand = escape(str(content["hero_title"]))
    html_block(
        f"""
        <div class="nav">
          <div class="nav-inner">
